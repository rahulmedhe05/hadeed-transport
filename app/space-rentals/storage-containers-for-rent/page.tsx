...
const space = spaceRentals.find((s) => s.slug === "storage-containers-for-rent")!

export const metadata: Metadata = {
  title: `${space.name} | Space Rentals`,
...
export default function StorageContainersPage() {
  return (
    <main className="min-h-screen">
      <Navigation />
      <PageHero title={space.name} subtitle={space.subtitle} imageSlug="storage-containers-for-rent" showForm={true} />
